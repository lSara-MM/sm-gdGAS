...
//{
//	editor = editor;
//	editor->deleteTag.SubscribeEvent(this, &TagContainerInspector::DeleteTags);
//}
//
...
//{
//	context.m_SelectedTree = memnew(godot::Tree);
//	context.m_SelectedTree->set_columns(1);
//	context.m_SelectedTree->set_h_size_flags(godot::Control::SIZE_EXPAND_FILL);
//	context.m_SelectedTree->set_v_size_flags(godot::Control::SIZE_EXPAND_FILL);
//	context.m_SelectedTree->set_custom_minimum_size(godot::Vector2(100, 70));
//
//	godot::TreeItem* rootItem = context.m_SelectedTree->create_item();
//	rootItem->set_selectable(0, false);
//	context.m_SelectedTree->set_hide_root(true);
//	context.m_SelectedTree->set_hide_folding(true);
//
...
//	{
//		TagID tagId = tags[i];
//		godot::TreeItem* item = context.m_SelectedTree->create_item(rootItem);
//		item->set_metadata(0, tagId);
//		item->set_text(0, m_IdToResource[tagId]);
//		item->add_button(0, remove);
//	}
//
//	context.m_SelectedTree->connect("button_clicked", callable_mp(this, &TagContainerInspector::_OnRemoveButtonClicked).bind(context.availableTree));
//	mainSplit->add_child(context.m_SelectedTree);
//}
//
