...
godot::TypedArray<godot::Node> sm::GAS_World::AnyTags(const godot::PackedInt32Array tags)
{
	godot::TypedArray<godot::Node> ret;
...
godot::TypedArray<godot::Node> sm::GAS_World::NoneTags(const godot::PackedInt32Array tags)
{
	godot::TypedArray<godot::Node> ret;
